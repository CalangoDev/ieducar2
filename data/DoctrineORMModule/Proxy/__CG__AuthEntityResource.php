 ...
 */
class Resource extends \Auth\Entity\Resource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'descricao', 'inputFilter');
        }
    ...
    public function setDescricao($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDescricao', array($value));

        return parent::setDescricao($value);
    }
