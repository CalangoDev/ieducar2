...
/**
 * Entidade Sc - Representa os ceps do estado do Santa Catarina, onde a cidade não tem cep único
 * 
...
class Sc extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_sc", initialValue=1, allocationSize=1)
	 */
	protected $id;
