...
/**
 * Entidade Ce - Representa os ceps do estado do Ceará, onde a cidade não tem cep único
 * 
...
class Ce extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_ce", initialValue=1, allocationSize=1)
	 */
	protected $id;
