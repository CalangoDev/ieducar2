...
/**
 * Entidade Se - Representa os ceps do estado do Sergipe, onde a cidade não tem cep único
 * 
...
class Se extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_se", initialValue=1, allocationSize=1)
	 */
	protected $id;
