...
/**
 * Entidade Rs - Representa os ceps do estado do Rio Grande do Sul, onde a cidade não tem cep único
 * 
...
class Rs extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_rs", initialValue=1, allocationSize=1)
	 */
	protected $id;
