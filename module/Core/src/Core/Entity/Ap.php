...
/**
 * Entidade Ap - Representa os ceps do estado do Amapá, onde a cidade não tem cep único
 * 
...
class Ap extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_ap", initialValue=1, allocationSize=1)
	 */
	protected $id;
