...
/**
 * Entidade Pa - Representa os ceps do estado do Pará, onde a cidade não tem cep único
 * 
...
class Pa extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_pa", initialValue=1, allocationSize=1)
	 */
	protected $id;
