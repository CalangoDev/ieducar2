...
/**
 * Entidade Pe - Representa os ceps do estado do Pernambuco, onde a cidade não tem cep único
 * 
...
class Pe extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_pe", initialValue=1, allocationSize=1)
	 */
	protected $id;
