...
/**
 * Entidade Sp - Representa os ceps do estado de São Paulo, onde a cidade não tem cep único
 * 
...
class Sp extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_sp", initialValue=1, allocationSize=1)
	 */
	protected $id;
