...
/**
 * Entidade Rj - Representa os ceps do estado do Rio de Janeiro, onde a cidade não tem cep único
 * 
...
class Rj extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_rj", initialValue=1, allocationSize=1)
	 */
	protected $id;
