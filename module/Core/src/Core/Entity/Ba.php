...
/**
 * Entidade Ba - Representa os ceps do estado da Bahia, onde a cidade não tem cep único
 * 
...
class Ba extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_ba", initialValue=1, allocationSize=1)
	 */
	protected $id;
