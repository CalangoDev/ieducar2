...
/**
 * Entidade Ac - Representa os ceps do estado do Acre, onde a cidade não tem cep único
 * 
...
class Ac extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_ac", initialValue=1, allocationSize=1)
	 */
	protected $id;
