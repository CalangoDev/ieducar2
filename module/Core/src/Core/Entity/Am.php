...
/**
 * Entidade Am - Representa os ceps do estado do Amazonas, onde a cidade não tem cep único
 * 
...
class Am extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_am", initialValue=1, allocationSize=1)
	 */
	protected $id;
