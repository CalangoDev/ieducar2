...
/**
 * Entidade Ac - Representa os ceps do estado do Goiás, onde a cidade não tem cep único
 * 
...
class Go extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_go", initialValue=1, allocationSize=1)
	 */
	protected $id;
