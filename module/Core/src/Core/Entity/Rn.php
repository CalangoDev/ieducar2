...
/**
 * Entidade Rn - Representa os ceps do estado do Rio Grande do Norte, onde a cidade não tem cep único
 * 
...
class Rn extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_rn", initialValue=1, allocationSize=1)
	 */
	protected $id;
