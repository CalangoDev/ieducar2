...
/**
 * Entidade Mt - Representa os ceps do estado do Mato Grosso, onde a cidade não tem cep único
 * 
...
class Mt extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_mt", initialValue=1, allocationSize=1)
	 */
	protected $id;
