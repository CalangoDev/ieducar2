...
/**
 * Entidade To - Representa os ceps do estado do Tocantins, onde a cidade não tem cep único
 * 
...
class To extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_to", initialValue=1, allocationSize=1)
	 */
	protected $id;
