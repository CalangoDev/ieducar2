...
/**
 * Entidade Ma - Representa os ceps do estado do Maranhão, onde a cidade não tem cep único
 * 
...
class Ma extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_ma", initialValue=1, allocationSize=1)
	 */
	protected $id;
