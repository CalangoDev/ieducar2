...
/**
 * Entidade Al - Representa os ceps do estado das Alagoas, onde a cidade não tem cep único
 * 
...
class Al extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_al", initialValue=1, allocationSize=1)
	 */
	protected $id;
