...
/**
 * Entidade Pb - Representa os ceps do estado da Paraíba, onde a cidade não tem cep único
 * 
...
class Pb extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_pb", initialValue=1, allocationSize=1)
	 */
	protected $id;
