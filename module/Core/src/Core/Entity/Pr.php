...
/**
 * Entidade Pr - Representa os ceps do estado do Paraná, onde a cidade não tem cep único
 * 
...
class Pr extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_pr", initialValue=1, allocationSize=1)
	 */
	protected $id;
