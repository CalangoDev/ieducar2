...
/**
 * Entidade Ms - Representa os ceps do estado do Mato Grosso do Sul, onde a cidade não tem cep único
 * 
...
class Ms extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_ms", initialValue=1, allocationSize=1)
	 */
	protected $id;
