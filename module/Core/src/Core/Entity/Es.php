...
/**
 * Entidade Es - Representa os ceps do estado do Espirito Santo, onde a cidade não tem cep único
 * 
...
class Es extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_es", initialValue=1, allocationSize=1)
	 */
	protected $id;
