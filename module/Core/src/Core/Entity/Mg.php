...
/**
 * Entidade Mg - Representa os ceps do estado de Minas Gerais, onde a cidade não tem cep único
 * 
...
class Mg extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_mg", initialValue=1, allocationSize=1)
	 */
	protected $id;
