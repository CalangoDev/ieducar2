...
/**
 * Entidade Df - Representa os ceps do estado do Distrito Federal, onde a cidade não tem cep único
 * 
...
class Df extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_df", initialValue=1, allocationSize=1)
	 */
	protected $id;
