...
/**
 * Entidade Rr - Representa os ceps do estado de Roraima, onde a cidade não tem cep único
 * 
...
class Rr extends Entity
{
	 ...
	 * @SequenceGenerator(sequenceName="cep.seq_rr", initialValue=1, allocationSize=1)
	 */
	protected $id;
